...
export default function WorkoutDetailsScreen({
  ...
  // ✅ Find the workout by ID from context
  ...
  const intensityKey = workout.intensity ?? "";
  const intensityCfg = INTENSITY_CONFIG[intensityKey] ?? DEFAULT_INTENSITY;
        ...
        {workout.intensity && (
          <View
            style={[
              ...
              { backgroundColor: intensityCfg.bg },
            ]}
          >
